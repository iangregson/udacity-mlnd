...
class Actor:
    ...
    def build_model(self):
        ...
        # CODE REVIEW: add batch normalization and dropout
        ...
        plot_model(self.model, to_file='actor_model.png')
        ...
        # CODE REVIEW: use a lower learning rate on the Adam optimizer
...
class Critic:
    ...
    def build_model(self):
        ...
        plot_model(self.model, to_file='critic_model.png')
